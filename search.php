...
/*background image */
#vendornew{background-image:url("img/main_spice2.jpg");
	// background-repeat: no-repeat;
	 background-attachment: fixed;
	  background-position: center
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item">
		     <a href="contact.php" style="color:white;" class="nav-link">Complain</a>
		  </li>
        <li class="nav-item mb-auto mt-auto">
          <a  href="comparing_restaurant.php" style="color:white;" class="nav-link">Compare Price</a>
        </li>
		  <?php
			if(empty($cust_id))
			{
			?>
			<li class="nav-item">
			  <a href="form/index.php?msg=you must be login first" class="nav-link"><span style="color:red;  font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:red;" id="cart"  class="badge badge-transparent">0</span></i></span></a>
		    </li>
			...
			?>
			<li class="nav-item">
			<a href="form/cart.php" class="nav-link"><form method="post"><span style=" color:green; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:green;" id="cart"  class="badge badge-transparent"><?php if(isset($re)) { echo $re; }?></span></i></span></form></a>
			</li>
			<li class="nav-item">
...
<!--menu ends-->
<div class="container" >
<img src="img/vendor1.gif" alt="no Pic Available" height="450px" width="100%">
</div>
