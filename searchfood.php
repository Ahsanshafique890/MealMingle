...
<div class="row">
   ...
   <?php
	  ...
	  <div class="container-fluid">
		 ...
		 <?php echo $res['fld_name']; ?></span><span style="color:black; margin-left:10px;"><i class="far fa-star checked"></i><i class="far fa-star checked"></i><i class="far fa-star checked"></i><i class="far fa-star"></i><i class="far fa-star"></i></span>
        </div>
		 <div class="col-sm-2"><span style="color:green; font-size:20px;"> <?php echo $res['cost']; ?></span><i style="font-weight: bold;"> Rs.</i></div>
		 <form method="post">
